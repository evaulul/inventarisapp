...
class ruangController extends Controller
{
    ...
    {
        $data = ruang::all();
        return view('administrator.ruang.tampil', compact('data'));
    }
    ...
    {
        $data = ruang::all();
        return view('administrator.ruang.input', compact('data'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view("administrator.ruang.edit", compact('data'));
    }
