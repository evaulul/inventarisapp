  ...
  <aside class="main-sidebar sidebar-light-purple elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset("asset/dist/img/kpgudang.png") }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Kepala Gudang</a>
        </div>
      </div>
      ...
      <nav class="mt-2 ">
        <ul class="nav nav-pills nav-sidebar  flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/peminjamankp" class="nav-link ">
          ...
          <li class="nav-item ">
            <a href="laporankp" class="nav-link ">
